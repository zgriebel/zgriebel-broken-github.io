...
![](~/portfolio_zg/_grip_strength/ama_28yrsold.jpg)

![](~/portfolio_zg/_grip_strength/Screenshot%202023-12-05%20083540.jpg)
...
![](~/portfolio_zg/_grip_strength/p1-2-3.png)
...
![](~/portfolio_zg/_grip_strength/p4-5-6.png)
...
When stratifying by age group and utilizing multiple features, models can predict grip-strength far more accurately. Above 60 years of age was used in the below graph because the most complete and largest data is a senior population data set.![](~/portfolio_zg/_grip_strength/60prediction.jpg)
...
![](~/portfolio_zg/_grip_strength/1970.jpg)
...
![With such large sample size confidence intervals are not visible.](~/portfolio_zg/_grip_strength/Men_overtime.jpg)
...
![Again, with a large sample size confidence intervals are minuscule.](~/portfolio_zg/_grip_strength/women_overtime.jpg)
